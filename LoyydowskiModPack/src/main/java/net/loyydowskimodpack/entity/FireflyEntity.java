...
public class FireflyEntity extends Monster {
    private static final ResourceLocation[] IDLE_SOUNDS = {
        new ResourceLocation("loyydowski_modpack", "fireflyidle"),
        new ResourceLocation("loyydowski_modpack", "idlefirefly2"),
        new ResourceLocation("loyydowski_modpack", "idlefirefly3")
    };

    public FireflyEntity(PlayMessages.SpawnEntity packet, Level world) {
        this(LoyydowskiModpackModEntities.FIREFLY.get(), world);
    }
    ...
    public SoundEvent getAmbientSound() {
        ResourceLocation soundLocation = IDLE_SOUNDS[this.random.nextInt(IDLE_SOUNDS.length)];
    ...
    public static void init() {
        SpawnPlacements.register(LoyydowskiModpackModEntities.FIREFLY.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
